...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Model.Operation"] = $PS["Model.Operation"] || {};
  var exports = $PS["Model.Operation"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Ordering = $PS["Data.Ordering"];                
  var Plus = (function () {
  ...
  var eqOperation = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Nop && y instanceof Nop) {
              return true;
          };
          return false;
      };
  });
  var ordOperation = new Data_Ord.Ord(function () {
      return eqOperation;
  }, function (x) {
      return function (y) {
          if (x instanceof Plus && y instanceof Plus) {
          ...
          throw new Error("Failed pattern match at Model.Operation (line 10, column 1 - line 10, column 46): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  exports["Plus"] = Plus;
  exports["Minus"] = Minus;
  ...
  exports["ordOperation"] = ordOperation;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Model.Calculator"] = $PS["Model.Calculator"] || {};
  var exports = $PS["Model.Calculator"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Model_Operation = $PS["Model.Operation"];                
  ...
  var Operation = (function () {
      function Operation(value0) {
          this.value0 = value0;
      };
      Operation.create = function (value0) {
          return new Operation(value0);
      };
      return Operation;
  })();
  var Num = (function () {
  ...
  var showCommand = new Data_Show.Show(function (v) {
      ...
      if (v instanceof Operation && v.value0 instanceof Model_Operation.Div) {
          return "\xf7";
      };
      if (v instanceof Operation && v.value0 instanceof Model_Operation.Prod) {
          return "\xd7";
      };
      if (v instanceof Operation && v.value0 instanceof Model_Operation.Plus) {
          return "+";
      };
      if (v instanceof Operation && v.value0 instanceof Model_Operation.Minus) {
          return "-";
      };
      if (v instanceof Operation && v.value0 instanceof Model_Operation.Nop) {
          return "Nop";
      };
      ...
      if (v instanceof Num) {
          return Data_Int.toStringAs(Data_Int.decimal)(v.value0);
      };
      throw new Error("Failed pattern match at Model.Calculator (line 28, column 1 - line 39, column 38): " + [ v.constructor.name ]);
  });
  var removeZeros = function (str) {
      var v = Data_String_Regex.regex("^([^.]*)(\\.)(0*[^0]+|)0+$")(Data_String_Regex_Flags.noFlags);
      if (v instanceof Data_Either.Left) {
          return "error";
      };
      if (v instanceof Data_Either.Right) {
          var v1 = Data_String_Regex.match(v.value0)(str);
          if (v1 instanceof Data_Maybe.Just) {
              var result = Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v1.value0)(1)))(function (l1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v1.value0)(2)))(function (l2) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v1.value0)(3)))(function (l3) {
                          if (l3 === "") {
                              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(l1 + l3);
                          };
                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(l1 + (l2 + l3));
                      });
                  });
              });
              return Data_Maybe.fromMaybe("---")(result);
          };
          return str;
      };
  ...
  var showModel = new Data_Show.Show(function (v) {
      ...
      return stringFromNumber(v.total);
  });
  var eqCommand = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof AC && y instanceof AC) {
              return true;
          };
          if (x instanceof PlusMinus && y instanceof PlusMinus) {
              return true;
          };
          ...
          if (x instanceof Operation && y instanceof Operation) {
              return Data_Eq.eq(Model_Operation.eqOperation)(x.value0)(y.value0);
          };
  ...
  var ordCommand = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          if (x instanceof PlusMinus) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof PlusMinus) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Percent && y instanceof Percent) {
              return Data_Ordering.EQ.value;
          ...
          if (y instanceof Equal) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Operation && y instanceof Operation) {
              return Data_Ord.compare(Model_Operation.ordOperation)(x.value0)(y.value0);
          };
          ...
          throw new Error("Failed pattern match at Model.Calculator (line 26, column 1 - line 26, column 42): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var calc = function (op) {
      return function (num1) {
          return function (num2) {
              if (op instanceof Model_Operation.Plus) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(num1 + num2);
              };
              if (op instanceof Model_Operation.Minus) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(num1 - num2);
              };
              if (op instanceof Model_Operation.Prod) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(num1 * num2);
              };
              if (op instanceof Model_Operation.Div) {
                  var $64 = num2 === 0.0;
                  if ($64) {
                      return Data_Maybe.Nothing.value;
                  };
  ...
  var updateTotal = function (op) {
      return function (total) {
          return function (next) {
              var $65 = next !== "";
              if ($65) {
                  return calc(op)(total)(Data_Maybe.fromMaybe(0.0)(Data_Number.fromString(next)));
              };
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(total);
          };
      };
  };
  var updateModel = function (op) {
      return function (v) {
          var v1 = updateTotal(v.operation)(v.total)(v.next);
          if (v1 instanceof Data_Maybe.Just) {
              return {
                  total: v1.value0,
                  next: "",
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return {
                  total: 0.0,
                  next: "",
                  operation: Model_Operation.Nop.value,
                  isError: true
              };
          };
          throw new Error("Failed pattern match at Model.Calculator (line 50, column 3 - line 63, column 8): " + [ v1.constructor.name ]);
      };
  };
  var handleCommand = function (command) {
      return function (v) {
          var calc1 = function (command$prime) {
              if (command$prime instanceof AC) {
                  return Model({
                      total: 0.0,
                      next: "",
                      operation: Model_Operation.Nop.value,
              ...
              if (command$prime instanceof PlusMinus) {
                  var $73 = v.next === "";
                  if ($73) {
                      return Model({
                          total: -v.total,
                  ...
                  return Model({
                      total: v.total,
                      next: (function () {
                          var v2 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_CodePoints.singleton)(Data_String_CodePoints.codePointAt(0)(v.next));
                          if (v2 instanceof Data_Maybe.Just && v2.value0 === "-") {
                              return Data_String_CodePoints.drop(1)(v.next);
                          };
                          return "-" + v.next;
                      })(),
              ...
              if (command$prime instanceof Percent) {
                  var $76 = v.next === "";
                  if ($76) {
                      return Model({
                          total: v.total * 1.0e-2,
                          next: "",
                          operation: Model_Operation.Nop.value,
                          isError: v.isError
                      });
                  ...
                  return Model({
                      total: v.total,
                      next: stringFromNumber(Data_Maybe.fromMaybe(0.0)(Data_Number.fromString(v.next)) / 100.0),
                      operation: v.operation,
                      isError: v.isError
                  });
              };
              if (command$prime instanceof Operation) {
                  return updateModel(command$prime.value0)(v);
              };
              if (command$prime instanceof Num) {
                  return Model({
                      total: v.total,
                      next: (function () {
                          var $78 = command$prime.value0 === 0 && v.next === "0";
                          if ($78) {
                              return v.next;
                          };
                          return v.next + Data_Int.toStringAs(Data_Int.decimal)(command$prime.value0);
                      })(),
                      operation: v.operation,
                      isError: v.isError
                  });
              };
              if (command$prime instanceof Dot) {
                  return Model({
                      total: v.total,
                      next: (function () {
                          var $80 = v.next === "";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["View.Button"] = $PS["View.Button"] || {};
  var exports = $PS["View.Button"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Show = $PS["Data.Show"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Model_Calculator = $PS["Model.Calculator"];
  var View_Button = $PS["View.Button"];                
  var Pushed = (function () {
      function Pushed(value0) {
          this.value0 = value0;
      };
      Pushed.create = function (value0) {
          return new Pushed(value0);
      };
      return Pushed;
  })();
  var Push = (function () {
  ...
  var render = function (state) {
      return View_Button.render(Model_Calculator.showCommand)(new Push(state))(state);
  };
  var handleAction = function (v) {
      return Halogen_Query_HalogenM.raise(new Pushed(v.value0));
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["View.Calculator"] = $PS["View.Calculator"] || {};
  var exports = $PS["View.Calculator"];
  var Data_Show = $PS["Data.Show"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  ...
  var Model_Calculator = $PS["Model.Calculator"];
  var Model_Operation = $PS["Model.Operation"];                
  var render = function (mkSlot) {
      return function (model) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("id")("root") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-app") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-display") ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text(Data_Show.show(Model_Calculator.showModel)(model)) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button-panel") ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(Model_Calculator.AC.value) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(Model_Calculator.PlusMinus.value) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(Model_Calculator.Percent.value) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button orange") ])([ mkSlot(new Model_Calculator.Operation(Model_Operation.Div.value)) ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(7)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(8)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(9)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button orange") ])([ mkSlot(new Model_Calculator.Operation(Model_Operation.Prod.value)) ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(4)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(5)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(6)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button orange") ])([ mkSlot(new Model_Calculator.Operation(Model_Operation.Minus.value)) ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(1)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(2)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(new Model_Calculator.Num(3)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button orange") ])([ mkSlot(new Model_Calculator.Operation(Model_Operation.Plus.value)) ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button wide") ])([ mkSlot(new Model_Calculator.Num(0)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button") ])([ mkSlot(Model_Calculator.Dot.value) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("component-button orange") ])([ mkSlot(Model_Calculator.Equal.value) ]) ]) ]) ]) ]);
      };
  };
  exports["render"] = render;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["View.Info"] = $PS["View.Info"] || {};
  var exports = $PS["View.Info"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var render = Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("https://github.com/knight9999/Calculator"), Halogen_HTML_Properties.attr("target")("_blank"), Halogen_HTML_Properties.attr("class")("github-fork-ribbon left-top"), Halogen_HTML_Properties.attr("title")("Fork me on GitHub") ])([ Halogen_HTML_Core.text("Fork me on GitHub") ]);
  exports["render"] = render;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  ...
  var Model_Calculator = $PS["Model.Calculator"];
  var Model_Operation = $PS["Model.Operation"];
  var View_Calculator = $PS["View.Calculator"];
  var View_Info = $PS["View.Info"];
  var Init = (function () {
      function Init() {
      ...
      return function (v) {
          ...
          if (v instanceof HandleButton) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var model$prime = Model_Calculator.handleCommand(v.value0.value0)(v1.model);
          ...
          throw new Error("Failed pattern match at Calculator (line 68, column 16 - line 74, column 44): " + [ v.constructor.name ]);
      };
  };
  var _button = Data_Symbol.SProxy.value;
  var render = function (dictMonadEffect) {
      return function (v) {
          return Halogen_HTML_Elements.body([  ])([ View_Calculator.render(function (command) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "button";
              }))(Model_Calculator.ordCommand)(_button)(command)(Button.component)(command)(function ($16) {
                  return Data_Maybe.Just.create(HandleButton.create($16));
              });
          })(v.model), View_Info.render ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(Halogen_Aff_Util.selectElement("html")))(function (html) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(Halogen_Aff_Util.selectElement("body")))(function (body) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect_Aff.monadAff))(Effect_Class.liftEffect(Control_Monad_Maybe_Trans.monadEffectMaybe(Effect_Aff.monadEffectAff))(Web_DOM_Node.removeChild(Web_HTML_HTMLElement.toNode(body))(Web_HTML_HTMLElement.toNode(html))))(function () {
                  return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Effect_Aff.monadAff)(Halogen_VDom_Driver.runUI(Calculator.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(html));
              });
          });
      }));
  }));
